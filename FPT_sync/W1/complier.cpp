/* Object: CodeChef 
Problem Number: COMPLIER
Title: Compliers and parsers %Link: https://vjudge.net/contest/492665#problem/A (Biên soạn và giấy tờ)
Author:
Writer:
Day write: 1/12  */
/*#include<iostream>
...
int lengthOfLongestPrefix(string s){
    ...
    stack<int> st;
    int size = s.size(), longesPrefixLength =0;
    //lặp lại chuỗi     Iterating the string
